...
# def rotate_letter(x, k):
   
#     # rotates a letter by k rotations
#     letter = ord(x)
...
#     # rotates a word by k rotations
#     result = ""
#     for x in word:
#         result += rotate_letter(x, k)
#     return result

# # prints the output
# print(rotate_word(word, k))
...
def rotate_word(word, shift):
    ...
    for i in word:
        ...
        #checking if the character is an alphabet
        if not (((letter_value >= ord("A")) and (letter_value <= ord("Z"))) or ((letter_value >= ord("a")) and (letter_value <= ord("z")))):
            #leaving the character unchanged if not an alphabet
            shifted_letter_value = letter_value
           ...
           #shift for uppercase letters
            ...
            #starting from 'Z' if the value is lesser than 'A'
            if ((shifted_letter_value < 65)): 
                # while (shifted_letter_value <= 65):
                ex_shifted_letter_value=shifted_letter_value+26
                new_letter=chr(ex_shifted_letter_value)

            #starting from 'A' if the value is greater than 'Z'
            elif ((shifted_letter_value > 90)): 
                # while (shifted_letter_value >= 90):
                ex_shifted_letter_value=shifted_letter_value-26
                new_letter=chr(ex_shifted_letter_value)
            ...
            #starting from 'z' if the value is lesser than 'a'
            if ((shifted_letter_value < 97)): 
                # while (shifted_letter_value <= 97):
                ex_shifted_letter_value=shifted_letter_value+26
                new_letter=chr(ex_shifted_letter_value)

            #starting from 'a' if the value is greater than 'z'
            elif ((shifted_letter_value > 122)): 
                # while (shifted_letter_value >= 122):
                ex_shifted_letter_value=shifted_letter_value-26
                new_letter=chr(ex_shifted_letter_value)
